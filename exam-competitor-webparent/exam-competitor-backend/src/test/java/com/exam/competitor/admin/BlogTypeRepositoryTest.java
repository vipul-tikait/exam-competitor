 ...
 * 
 * import com.exam.competitor.admin.common.entity.blog.BlogType; import
 * com.exam.competitor.admin.repo.BlogTypeRepository;
 * 
 * @DataJpaTest
 * 
 * @AutoConfigureTestDatabase(replace = Replace.NONE)
 * 
 * @Rollback(false) public class BlogTypeRepositoryTest {
 * 
 * @Autowired private BlogTypeRepository repository;
 * 
 * @Test public void testCreateBlog() {
 * 
 * BlogType bt = new BlogType("GS-III");
 * 
 * BlogType savedBrand = repository.save(bt);
 * //assertThat(savedBrand).isNotNull();
 * assertThat(savedBrand.getName()).isEqualTo("GS-III"); }
 * 
