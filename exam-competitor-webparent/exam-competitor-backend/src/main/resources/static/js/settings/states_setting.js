...
function loadStates4Country() {
	/*	selectedCountry = $('#dropDownCountriesForStates').find(":selected");
		countryId = selectedCountry.val();
	...
	var countryId = $('#dropDownCountriesForStates').find(":selected").val();
	var csrf = $("input[name='_csrf']").val();
	url = contextPath + "states/list_by_country";
