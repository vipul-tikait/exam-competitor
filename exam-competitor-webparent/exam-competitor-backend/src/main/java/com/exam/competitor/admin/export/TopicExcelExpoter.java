...
public class TopicExcelExpoter extends AbstactExporter{
	
	private XSSFWorkbook workbook;
	private XSSFSheet sheet;
	
	public TopicExcelExpoter() {
		workbook = new XSSFWorkbook();
	}
	
	private void writeHeaderLine() {
		sheet = workbook.createSheet("Topic");
	...
	private void writeDataLines(List<Topic> listAll) {
		int rowIndex = 1;
